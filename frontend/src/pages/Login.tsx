    ...
    <div className="min-h-screen bg-gray-50 boca-page flex items-center justify-center">
      <div className="w-full max-w-md">
        ...
        <div className="bg-brand-dark rounded-t-2xl px-8 pt-12 pb-10 relative overflow-hidden flex flex-col items-center">
          ...
          <p className="relative mt-1.5 text-white/50 text-xs tracking-wide">{t('auth.taglineTeam')}</p>
        </div>
        ...
        <div className="bg-white rounded-b-2xl shadow-md px-8 py-6">
          <p className="text-gray-500 text-sm mb-5">
            {t('auth.signInPrompt')}{' '}
            <Link to="/register" className="text-brand-green hover:underline font-medium">{t('auth.createOne')}</Link>
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <Link to="/forgot-password" className="text-xs text-brand-green hover:underline">{t('auth.forgotPassword')}</Link>
              </div>
              <input
                id="password"
                type="password"

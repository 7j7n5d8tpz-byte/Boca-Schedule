...
-- ── Signups ──────────────────────────────────────────────────────────────────
-- Match 1 (10 Jun): 12 players
-- Match 2 (17 Jun): 13 players — heavy overlap with match 1 for joint-opt testing
-- Match 3 (24 Jun): 11 players — mix of match 1 and match 2 pools

-- Match 1 (12 signups)
INSERT INTO signups (match_id, player_id)
SELECT 'b2000001-0000-0000-0000-000000000001', user_id
FROM users WHERE email IN (
  'anders.larsen@boca.dk',
  'martin.jensen@boca.dk',
  'mikkel.hansen@boca.dk',
  'oliver.rasmussen@boca.dk',
  'lars.petersen@boca.dk',
  'magnus.eriksen@boca.dk',
  'thomas.nielsen@boca.dk',
  'soren.madsen@boca.dk',
  'christian.holm@boca.dk',
  'jonas.berg@boca.dk',
  'alexander.dahl@boca.dk',
  'mads.lund@boca.dk'
)
...
-- Match 2 (13 signups)
INSERT INTO signups (match_id, player_id)
SELECT 'b2000001-0000-0000-0000-000000000002', user_id
FROM users WHERE email IN (
  'martin.jensen@boca.dk',
  'mikkel.hansen@boca.dk',
  'oliver.rasmussen@boca.dk',
  'lars.petersen@boca.dk',
  'magnus.eriksen@boca.dk',
  'nikolaj.poulsen@boca.dk',
  'kasper.moller@boca.dk',
  'rasmus.christensen@boca.dk',
  'christian.holm@boca.dk',
  'jonas.berg@boca.dk',
  'victor.kjaer@boca.dk',
  'simon.brandt@boca.dk',
  'tobias.holm@boca.dk'
)
ON CONFLICT DO NOTHING;
...
-- Match 3 (11 signups)
INSERT INTO signups (match_id, player_id)
SELECT 'b2000001-0000-0000-0000-000000000003', user_id
FROM users WHERE email IN (
  'anders.larsen@boca.dk',
  'thomas.nielsen@boca.dk',
  'soren.madsen@boca.dk',
  'nikolaj.poulsen@boca.dk',
  'kasper.moller@boca.dk',
  'frederik.christiansen@boca.dk',
  'alexander.dahl@boca.dk',
  'mads.lund@boca.dk',
  'daniel.juhl@boca.dk',
  'patrick.norgaard@boca.dk',
  'benjamin.storm@boca.dk'
)
ON CONFLICT DO NOTHING;
